...
namespace DiiagramrAPI.Editor
{
    public class TypeColorProvider
    {
        ...
        private readonly Color _defaultColor = Color.FromArgb(0, 100, 100, 100);
        private readonly Dictionary<Type, Color> _terminalColorToTypeMap = new Dictionary<Type, Color>();

        private TypeColorProvider()
        {
            RegisterColorForType(typeof(int), Color.FromArgb(0, 39, 116, 85));
            RegisterColorForType(typeof(float), Color.FromArgb(0, 45, 110, 100));
            RegisterColorForType(typeof(byte[]), Color.FromArgb(0, 170, 122, 57));
            RegisterColorForType(typeof(string), Color.FromArgb(0, 153, 51, 80));
            RegisterColorForType(typeof(bool), Color.FromArgb(0, 200, 51, 80));
            RegisterColorForType(typeof(object), Color.FromArgb(0, 155, 155, 155));
        }
