...
namespace DiiagramrFadeCandy
{
    public class ColorNode : Node
    {
        ...
        [InputTerminal("Pick Random", Direction.East)]
        ...
        [InputTerminal("Red", Direction.North)]
        ...
        [InputTerminal("Green", Direction.North)]
        ...
        [InputTerminal("Blue", Direction.North)]
        ...
        [InputTerminal("Alpha", Direction.West)]
