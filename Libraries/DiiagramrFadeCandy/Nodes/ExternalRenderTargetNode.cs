...
{
    [Help("Provides a surface to draw effects on that is visible in another window.")]
    public class ExternalRenderTargetNode : Node, ILedDataProvider
    {
        ...
        public void OpenWindowMouseDown()
        {
            _graphicsWindow = new GraphicsWindow();
            _graphicsWindow.Show();
        }

        public void FullScreenMouseDown()
        {
            if (_graphicsWindow != null)
            {
                if (_graphicsWindow.WindowState != System.Windows.WindowState.Maximized)
                {
                    _graphicsWindow.WindowState = System.Windows.WindowState.Maximized;
                    _graphicsWindow.WindowStyle = System.Windows.WindowStyle.None;
                }
                else
                {
                    _graphicsWindow.WindowState = System.Windows.WindowState.Minimized;
                    _graphicsWindow.WindowStyle = System.Windows.WindowStyle.SingleBorderWindow;
                }
            }
        }
        ...
        {
            if (View != null && _graphicsWindow != null)
            {
                _graphicsWindow.RenderSurface.Source = BitmapConverter.GetBitmapSourceFromWicBitmap(WicBitmap, BitmapWidth, BitmapHeight, _bitmapLock);
            }
        }
