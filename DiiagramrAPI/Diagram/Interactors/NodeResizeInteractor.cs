...
{
    public class NodeResizeInteractor : DiagramInteractor
    {
        ...
        public override bool ShouldStartInteraction(DiagramInteractionEventArguments interaction)
        {
            if ((interaction.Type == InteractionType.LeftMouseDown 
              ...
              && interaction.ViewModelMouseIsOver is PluginNode node)
            {
                ...
                var absoluteLeft = diagram.GetViewPointFromDiagramPointX(node.X + DiagramViewModel.NodeBorderWidth);
                var absoluteTop = diagram.GetViewPointFromDiagramPointY(node.Y + DiagramViewModel.NodeBorderWidth);
                var absoluteRight = diagram.GetViewPointFromDiagramPointX(node.X + node.Width + DiagramViewModel.NodeBorderWidth);
                var absoluteBottom = diagram.GetViewPointFromDiagramPointY(node.Y + node.Height + DiagramViewModel.NodeBorderWidth);
